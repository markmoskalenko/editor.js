      ...
      get: function get() {
        ...
        inputs = inputs.reduce(function (result, input) {
          if (_dom.default.isNativeInput(input) || _dom.default.containsOnlyInlineElements(input)) {
            return (0, _toConsumableArray2.default)(result).concat([input]);
          }

          return (0, _toConsumableArray2.default)(result).concat((0, _toConsumableArray2.default)(_dom.default.getDeepestBlockElements(input)));
        }, []);
        /**
    ...
    (0, _createClass2.default)(Dom, null, [{
      ...
      value: function getDeepestBlockElements(parent) {
        ...
        return Array.from(parent.children).reduce(function (result, element) {
          return (0, _toConsumableArray2.default)(result).concat((0, _toConsumableArray2.default)(Dom.getDeepestBlockElements(element)));
        }, []);
      }
    }, {
      key: "blockElements",
    ...
    function Paste() {
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee(event) {
          var _this$Editor, BlockManager, Tools, Toolbar, isInitialTool;
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  isInitialTool = BlockManager.currentBlock && Tools.isInitial(BlockManager.currentBlock.tool);
    ...
    (0, _createClass2.default)(Paste, [{
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee4(items) {
          ...
          var _this$Editor2, BlockManager, Tools, dataToInsert, isCurrentBlockInitial, needToReplaceCurrentBlock;

          return _regenerator.default.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _this$Editor2 = this.Editor, BlockManager = _this$Editor2.BlockManager, Tools = _this$Editor2.Tools;
                  _context4.next = 3;
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  ...
                  _this$Editor3 = this.Editor, Caret = _this$Editor3.Caret, BlockManager = _this$Editor3.BlockManager, Tools = _this$Editor3.Tools;
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee9(dataToInsert) {
          var initialTool, _this$Editor6, BlockManager, Caret, Sanitizer, Tools, content, tool, blockData, insertedBlock, needToReplaceCurrentBlock, currentToolSanitizeConfig;

          return _regenerator.default.wrap(function _callee9$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  initialTool = this.config.initialBlock, _this$Editor6 = this.Editor, BlockManager = _this$Editor6.BlockManager, Caret = _this$Editor6.Caret, Sanitizer = _this$Editor6.Sanitizer, Tools = _this$Editor6.Tools, content = dataToInsert.content, tool = dataToInsert.tool;
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts"), __webpack_require__(/*! ../dom */ "./src/components/dom.ts"), __webpack_require__(/*! ../selection */ "./src/components/selection.ts"), __webpack_require__(/*! ../block */ "./src/components/block.ts"), __webpack_require__(/*! ./ui */ "./src/components/modules/ui.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _dom, _selection, _block, _ui) {
  "use strict";
  ...
  function (_Module) {
    ...
    function RectangleSelection() {
      ...
      _this.HEIGHT_OF_SCROLL_ZONE = 25;
      /**
    ...
    (0, _createClass2.default)(RectangleSelection, [{
      ...
      value: function prepare() {
        ...
        var _this$genHTML = this.genHTML(),
            overlayTopScrollZone = _this$genHTML.overlayTopScrollZone,
            overlayBottomScrollZone = _this$genHTML.overlayBottomScrollZone,
            container = _this$genHTML.container,
            overlay = _this$genHTML.overlay;

        Listeners.on(overlayBottomScrollZone, 'mouseenter', function (event) {
          _this2.inScrollZone = _this2.BOTTOM_SCROLL_ZONE;

          _this2.scrollVertical(_this2.SCROLL_SPEED);
        });
        Listeners.on(overlayTopScrollZone, 'mouseenter', function (event) {
          _this2.inScrollZone = _this2.TOP_SCROLL_ZONE;
        ...
        Listeners.on(document.body, 'mouseleave', function (event) {
      ...
      value: function startSelection(pageX, pageY) {
        ...
        if (!(elemWhereSelectionStart.closest('.' + _ui.default.CSS.editorWrapper) && !elemWhereSelectionStart.closest('.' + _block.default.CSS.content))) {
          return;
        }
        ...
        this.startX = pageX;
        this.startY = pageY;
        var container = document.querySelector('.' + _ui.default.CSS.editorWrapper);
      }
      /**
      ...
      value: function genHTML() {
        ...
        var overlayTopScrollZone = _dom.default.make('div', RectangleSelection.CSS.topScrollZone, {});

        var overlayBottomScrollZone = _dom.default.make('div', RectangleSelection.CSS.bottomScrollZone, {});
        ...
        return {
          overlayBottomScrollZone: overlayBottomScrollZone,
          overlayTopScrollZone: overlayTopScrollZone,
          container: container,
          overlay: overlay
        };
      }
      ...
      value: function inverseSelection() {
        ...
        if (!this.rectCrossesBlocks && isSelecteMode) {
          for (var _i = 0; _i < this.stackOfSelected.length; _i++) {
            this.Editor.BlockSelection.unSelectBlockByIndex(this.stackOfSelected[_i]);
          }
        }
      }
      /**
      ...
      value: function genInfoForMouseSelection() {
        ...
        var Y = this.getHorizontalMousePosition();
      ...
      key: "getHorizontalMousePosition",
      value: function getHorizontalMousePosition() {
        var value = this.mouseY - window.pageYOffset; // To look at the item below the zone
      ...
      value: function trySelectNextBlock(index) {
        ...
        if (!reduction && (index > this.stackOfSelected[sizeStack - 1] || this.stackOfSelected[sizeStack - 1] === undefined)) {
          var _i2 = this.stackOfSelected[sizeStack - 1] + 1 || index;

          for (_i2; _i2 <= index; _i2++) {
            this.addBlockInSelection(_i2);
          }
        ...
        if (!reduction && index < this.stackOfSelected[sizeStack - 1]) {
          for (var _i3 = this.stackOfSelected[sizeStack - 1] - 1; _i3 >= index; _i3--) {
            this.addBlockInSelection(_i3);
          }
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Toolbox, [{
      ...
      value: function close() {
        ...
        var activeButton = this.nodes.toolbox.querySelector(".".concat(this.CSS.toolboxButtonActive));
      ...
      value: function leaf() {
        ...
        if (this.activeButtonIndex === -1) {
           ...
           */
          childNodes[this.activeButtonIndex].classList.remove(this.CSS.toolboxButtonActive);
        }
        /**
        ...
        childNodes[this.activeButtonIndex].classList.add(this.CSS.toolboxButtonActive);
      }
      /**
      ...
      value: function showTooltip(button, toolName) {
        ...
        this.nodes.tooltip.style.left = "".concat(coordinate + offset, "px");
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(UI, [{
      ...
      value: function addLoader() {
        this.nodes.loader = _dom.default.make('div', UI.CSS.editorLoader);
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 3:
                   ...
                   */
                  this.nodes.wrapper = _dom.default.make('div', UI.CSS.editorWrapper);
                  this.nodes.redactor = _dom.default.make('div', UI.CSS.editorZone);
                  /**
      ...
      value: function defaultBehaviour(event) {
        var keyDownOnEditor = event.target.closest(".".concat(UI.CSS.editorWrapper));
        var currentBlock = this.Editor.BlockManager.currentBlock;
      ...
      value: function documentClicked(event) {
        ...
        var clickedInsideofEditor = target.closest(".".concat(UI.CSS.editorWrapper));
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.11.2");
...
// module
exports.push([module.i, ".codex-editor{position:relative;box-sizing:border-box;z-index:1}.codex-editor .hide{display:none}.codex-editor__redactor{padding-bottom:300px}.codex-editor__redactor--hidden{display:none}@media (min-width:651px){.codex-editor--narrow .codex-editor__redactor{margin-right:50px}}@media (min-width:651px){.codex-editor--narrow .ce-toolbar__actions{right:-5px}}.codex-editor__loader{position:relative;height:30vh}.codex-editor__loader:before{content:\"\";position:absolute;left:50%;top:50%;width:30px;height:30px;margin-top:-15px;margin-left:-15px;border-radius:50%;border:2px solid hsla(240,3%,79%,.48);border-top-color:transparent;box-sizing:border-box;animation:d .8s infinite linear;will-change:transform}.codex-editor-copyable{position:absolute;height:1px;width:1px;top:-400%;opacity:.001}.codex-editor-overlay{position:fixed;top:0;left:0;right:0;bottom:0;z-index:999;pointer-events:none;overflow:hidden}.codex-editor-overlay__container{position:relative;pointer-events:auto;z-index:0}.codex-editor-overlay__rectangle{position:absolute;pointer-events:none;background-color:rgba(46,170,220,.2);border:1px solid transparent}.codex-editor-overlay__scroll-zone--top{top:0;width:100%;height:30px;position:fixed;pointer-events:auto;z-index:10500}.codex-editor-overlay__scroll-zone--bottom{bottom:0;width:100%;height:30px;position:fixed;pointer-events:auto;z-index:10500}.codex-editor svg{fill:currentColor;vertical-align:middle;max-height:100%}::selection{background-color:#a8d6ff}[contentEditable=true][data-placeholder]:empty:before{content:attr(data-placeholder);color:#707684;font-weight:400}[contentEditable=true][data-placeholder]:empty:focus:before{opacity:.3}.ce-toolbar{position:absolute;left:0;right:0;top:0;transition:opacity .1s ease;will-change:opacity,transform;display:none}@media (max-width:650px){.ce-toolbar{position:fixed;bottom:0;top:auto;left:0;right:0;z-index:9;height:50px;background:#fff;box-shadow:0 -2px 12px rgba(60,67,81,.18);transform:none!important}}.ce-toolbar--opened{display:block}@media (max-width:650px){.ce-toolbar--opened{display:-ms-flexbox;display:flex}}.ce-toolbar__content{max-width:650px;margin:0 auto;position:relative}@media (max-width:650px){.ce-toolbar__content{display:-ms-flexbox;display:flex;-ms-flex-line-pack:center;align-content:center;margin:0;padding:0 10px;max-width:calc(100% - 70px);overflow-x:auto}}.ce-toolbar__plus{color:#707684;cursor:pointer;width:34px;height:34px;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;position:absolute;left:-34px}.ce-toolbar__plus--active,.ce-toolbar__plus:hover{color:#388ae5}.ce-toolbar__plus--active{animation:b .75s 1;animation-fill-mode:forwards}.ce-toolbar__plus--hidden{display:none}@media (max-width:650px){.ce-toolbar__plus{display:none!important}}.ce-toolbar .ce-toolbox,.ce-toolbar__plus{top:50%;transform:translateY(-50%)}.ce-toolbar__actions{position:absolute;right:0;top:10px;padding-right:16px;opacity:0}@media (max-width:650px){.ce-toolbar__actions{position:static;margin-left:auto;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center}}.ce-toolbar__actions--opened{opacity:1}.ce-toolbar__actions-buttons{text-align:right}.ce-toolbar__settings-btn{display:inline-block;width:24px;height:24px;color:#707684;cursor:pointer}@media (min-width:651px){.codex-editor--narrow .ce-toolbar__plus{left:5px}}.ce-toolbox{position:absolute;visibility:hidden;transition:opacity .1s ease;will-change:opacity;display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row}@media (max-width:650px){.ce-toolbox{position:static;transform:none!important;-ms-flex-align:center;align-items:center;visibility:visible!important}}.ce-toolbox--opened{opacity:1;visibility:visible}.ce-toolbox__button{color:#707684;cursor:pointer;width:34px;height:34px;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center}.ce-toolbox__button--active,.ce-toolbox__button:hover{color:#388ae5}.ce-toolbox__button--active{animation:b .75s 1;animation-fill-mode:forwards}.ce-toolbox__tooltip{position:absolute;top:43px;padding:6px 10px;transform:translateX(-50%);border-radius:5px;line-height:21px;opacity:0;background:#eff2f5;box-shadow:0 10px 12px -9px rgba(26,39,54,.32),0 3px 2px -2px rgba(33,48,73,.05);color:#5c6174;font-size:12px;text-align:center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;pointer-events:none;transition:opacity .15s ease-in,left .1s linear;will-change:opacity,left;letter-spacing:.02em;line-height:1em}.ce-toolbox__tooltip-shortcut{color:rgba(100,105,122,.6);word-spacing:-2px;margin-top:5px}.ce-toolbox__tooltip--shown{opacity:1;transition-delay:.1s,0s}.ce-toolbox__tooltip:before{content:\"\";width:10px;height:10px;position:absolute;top:-5px;left:50%;margin-left:-5px;transform:rotate(-45deg);background-color:#eff2f5;z-index:-1}@media (min-width:651px){.codex-editor--narrow .ce-toolbox{background:#fff;z-index:2}}.ce-inline-toolbar{position:absolute;background-color:#fff;box-shadow:0 8px 23px -6px rgba(21,40,54,.31),22px -14px 34px -18px rgba(33,48,73,.26);border-radius:4px;z-index:2}.ce-inline-toolbar:before{content:\"\";width:15px;height:15px;position:absolute;top:-7px;left:50%;margin-left:-7px;transform:rotate(-45deg);background-color:#fff;z-index:-1}.ce-inline-toolbar{padding:6px;transform:translateX(-50%);display:none;box-shadow:0 6px 12px -6px rgba(131,147,173,.46),5px -12px 34px -13px rgba(97,105,134,.6),0 26px 52px 3px rgba(147,165,186,.24)}.ce-inline-toolbar--showed{display:block}.ce-inline-toolbar [hidden]{display:none!important}.ce-inline-toolbar__buttons{display:-ms-flexbox;display:flex}.ce-inline-tool{display:-ms-inline-flexbox;display:inline-flex;width:34px;height:34px;line-height:34px;text-align:center;border-radius:3px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:#707684}.ce-inline-tool:not(:last-of-type){margin-right:5px}.ce-inline-tool:hover{background-color:#eff2f5}.ce-inline-tool{line-height:normal}.ce-inline-tool .icon,.ce-inline-tool>svg{margin:auto}.ce-inline-tool--active{color:#388ae5}.ce-inline-tool--last{margin-right:0!important}.ce-inline-tool--link .icon{margin-top:-2px}.ce-inline-tool--link .icon--unlink,.ce-inline-tool--unlink .icon--link{display:none}.ce-inline-tool--unlink .icon--unlink{display:inline-block}.ce-inline-tool-input{background-color:#eff2f5;outline:none;border:0;border-radius:3px;margin:6px 0 0;font-size:13px;padding:8px;width:100%;box-sizing:border-box;display:none}.ce-inline-tool-input::-webkit-input-placeholder{color:#707684}.ce-inline-tool-input:-ms-input-placeholder,.ce-inline-tool-input::-ms-input-placeholder{color:#707684}.ce-inline-tool-input::placeholder{color:#707684}.ce-inline-tool-input--showed{display:block}.ce-settings{box-shadow:0 8px 23px -6px rgba(21,40,54,.31),22px -14px 34px -18px rgba(33,48,73,.26);border-radius:4px;z-index:2}.ce-settings,.ce-settings:before{position:absolute;background-color:#fff}.ce-settings:before{content:\"\";width:15px;height:15px;top:-7px;left:50%;margin-left:-7px;transform:rotate(-45deg);z-index:-1}.ce-settings{right:5px;top:35px;min-width:124px}@media (max-width:650px){.ce-settings{bottom:50px;top:auto}}.ce-settings:before{left:auto;right:12px}@media (max-width:650px){.ce-settings:before{bottom:-5px;top:auto}}.ce-settings{display:none}.ce-settings--opened{display:block;animation-duration:.5s;animation-name:b}.ce-settings__plugin-zone:not(:empty){padding:6px 6px 0}.ce-settings__default-zone:not(:empty){padding:6px}.ce-settings__button{display:-ms-inline-flexbox;display:inline-flex;width:34px;height:34px;line-height:34px;text-align:center;border-radius:3px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:#707684}.ce-settings__button:not(:last-of-type){margin-right:5px}.ce-settings__button:hover{background-color:#eff2f5}.ce-settings__button{line-height:32px}.ce-settings__button .icon,.ce-settings__button>svg{margin:auto}.ce-settings__button--active{color:#388ae5}.ce-settings__button--disabled{cursor:not-allowed!important;opacity:.3}.ce-settings__button--selected{color:#388ae5}.ce-settings__button--delete{transition:background-color .3s ease;will-change:background-color}.ce-settings__button--delete .icon{transition:transform .2s ease-out;will-change:transform}.ce-settings__button--confirm{background-color:#e24a4a;color:#fff}.ce-settings__button--confirm:hover{background-color:#d54a4a!important}.ce-settings__button--confirm .icon{transform:rotate(90deg)}.ce-block:first-of-type{margin-top:0}.ce-block--focused{background-image:linear-gradient(17deg,rgba(243,248,255,.03) 63.45%,rgba(207,214,229,.27) 98%);border-radius:3px}@media (max-width:650px){.ce-block--focused{background-image:none;background-color:rgba(200,199,219,.17);margin:0 -10px;padding:0 10px}}.ce-block--selected .ce-block__content{background:#a8d6ff;box-shadow:0 31px 23px -22px #afdcff;animation:c .2s 1;animation-fill-mode:forwards}.ce-block--selected .ce-block__content .ce-stub,.ce-block--selected .ce-block__content img{opacity:.55}.ce-block--stretched .ce-block__content{max-width:none}.ce-block__content{position:relative;max-width:650px;margin:0 auto}.ce-block--drop-target .ce-block__content:before{content:\"\";position:absolute;top:100%;left:-20px;margin-top:-1px;height:8px;width:8px;border:solid #388ae5;border-width:1px 1px 0 0;transform-origin:right;transform:rotate(45deg)}.ce-block--drop-target .ce-block__content:after{content:\"\";position:absolute;top:100%;height:1px;width:100%;color:#388ae5;background:repeating-linear-gradient(90deg,#388ae5,#388ae5 1px,#fff 0,#fff 6px)}.ce-block a{cursor:pointer;text-decoration:underline}.ce-block b{font-weight:700}.ce-block i{font-style:italic}@media (min-width:651px){.codex-editor--narrow .ce-block--focused{margin-right:-50px;padding-right:50px}}.wobble{animation-name:a;animation-duration:.4s}@keyframes a{0%{transform:translateZ(0)}15%{transform:translate3d(-5%,0,0) rotate(-5deg)}30%{transform:translate3d(2%,0,0) rotate(3deg)}45%{transform:translate3d(-3%,0,0) rotate(-3deg)}60%{transform:translate3d(2%,0,0) rotate(2deg)}75%{transform:translate3d(-1%,0,0) rotate(-1deg)}to{transform:translateZ(0)}}@keyframes b{0%,20%,40%,60%,80%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}0%{transform:scale3d(.9,.9,.9)}20%{transform:scale3d(1.03,1.03,1.03)}60%{transform:scaleX(1)}}@keyframes c{0%,20%,40%,60%,80%,to{animation-timing-function:cubic-bezier(.215,.61,.355,1)}50%{transform:scale3d(1.01,1.01,1.01)}70%{transform:scaleX(1)}}.cdx-block{padding:.7em 0}.cdx-input{border:1px solid hsla(240,3%,79%,.48);box-shadow:inset 0 1px 2px 0 rgba(35,44,72,.06);border-radius:3px;padding:10px 12px;outline:none;width:100%;box-sizing:border-box}.cdx-settings-button{display:-ms-inline-flexbox;display:inline-flex;width:34px;height:34px;line-height:34px;text-align:center;border-radius:3px;cursor:pointer;border:0;outline:none;background-color:transparent;vertical-align:bottom;color:#707684}.cdx-settings-button:not(:last-of-type){margin-right:5px}.cdx-settings-button:hover{background-color:#eff2f5}.cdx-settings-button .icon,.cdx-settings-button>svg{margin:auto}.cdx-settings-button--active{color:#388ae5}.cdx-loader{position:relative;border:1px solid hsla(240,3%,79%,.48)}.cdx-loader:before{content:\"\";position:absolute;left:50%;top:50%;width:18px;height:18px;margin:-11px 0 0 -11px;border:2px solid hsla(240,3%,79%,.48);border-left-color:#388ae5;border-radius:50%;animation:d 1.2s infinite linear}@keyframes d{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.cdx-button{padding:13px;border-radius:3px;border:1px solid hsla(240,3%,79%,.48);font-size:14.9px;background:#fff;box-shadow:0 2px 2px 0 rgba(18,30,57,.04);color:#707684;text-align:center;cursor:pointer}.cdx-button:hover{background:#fbfcfe;box-shadow:0 1px 3px 0 rgba(18,30,57,.08)}.cdx-button svg{height:20px;margin-right:.2em;margin-top:-2px}.ce-stub{display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-ms-flex-pack:center;justify-content:center;width:100%;padding:3.5em 0;margin:17px 0;border-radius:3px;background:#fcf7f7;color:#b46262}.ce-stub__info{margin-left:20px}.ce-stub__title{margin-bottom:3px;font-weight:600;font-size:18px;text-transform:capitalize}.ce-stub__subtitle{font-size:16px}", ""]);
